...
public:
    ...
    void withdraw(double amount){
        if (0 < amount && amount <= balance){
            balance -= amount;
            std::cout << "You have withdrawn from your balance: " << amount << std::endl;
            ...
            std::cout << "Invalid value. The value must be greater than 0." << std::endl;
        }
    }
    ...
    void deposit(double amount){
        if (amount > 0){
            balance += amount;
            std::cout << "You have topped up your balance by: " << amount << std::endl;
            std::cout << "Your balance is: " << balance << std::endl;
        }
        else {
            std::cout << "Invalid value. The value must be greater than 0" << std::endl;
    ...
    do{
        ...
        switch (choice){
            case 1:
                ...
                if (account != nullptr) {
                    std::cout << "Account already exists! You cannot create another one." << std::endl;
                ...
                while (success == false){
                    ...
                    std::cout << "Password: ";
                    std::cin >> password;
                    std::cout << "Enter your name and the initial balance amount" << std::endl;
                    ...
                    if (balance <= 0){
                        std::cout << "Invalid value. The balance must be greater than 0." << std::endl;
                        continue;
                    }
                    else {
